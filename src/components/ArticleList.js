...
/*
 <Article id={1} title={props.title} preview={props.preview} minutes={props.minutes}></Article>
 <Article id={2} title={props.title} preview={props.preview} minutes={props.minutes}></Article>
 <Article id={3} title={props.title} preview={props.preview} minutes={props.minutes}></Article>
*/
